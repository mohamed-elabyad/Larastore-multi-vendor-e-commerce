                                ...
                                <div class="divide-y divide-gray-100">
                                    @foreach ($group['items'] as $itemIndex => $item)
                                        <div class="p-4 sm:p-6 hover:bg-gray-50 transition"
                                            x-show="!items['{{ $item['product_id'] }}_{{ implode('_', $item['option_ids']) }}']?.deleted">
                                                    ...
                                                    <div class="flex flex-wrap items-center gap-3 text-sm">
                                                        ...
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <div
                                                                ...
                                                                <button
                                                                    @click="updateQuantity('{{ $item['product_id'] }}', {{ json_encode(array_values($item['option_ids'])) }}, -1, {{ $item['price'] }})"
                                                                    :disabled="loading"
                                                                ...
                                                                <span
                                                                    class="px-3 py-1 text-center font-medium min-w-[2rem]"
                                                        ...
                                                        <!-- Delete -->
                                                        <button
                                                            @click="deleteItem('{{ $item['product_id'] }}', {{ json_encode(array_values($item['option_ids'])) }}, {{ $item['price'] }}, {{ $item['quantity'] }})"
                                                            :disabled="loading"
                            ...
                            <div class="mb-6">
                                <div class="text-gray-700 mb-2">
                                    ...
                                    <span class="text-gray-600"> (<span
                                            x-text="totalQuantity">{{ $totalQuantity }}</span> items):</span>
                                </div>
